...
import com.example.online_food.Data.KhachHang;
...
public class TaiKhoanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isUserLoggedIn()) {
            ...
            CollectionReference khachHang = db.collection("KhachHang");
            khachHang.whereEqualTo("MaKhachHang", maKhachHang).get()
                            ...
                            if(task.isSuccessful()) {
                                ...
                                if(snapshot != null) {
                                    for(QueryDocumentSnapshot doc: snapshot) {
                                        String hinhAnhKH= doc.getString("HinhAnh");

                                        if(hinhAnhKH != null && !hinhAnhKH.isEmpty()) {
                                            Glide.with(TaiKhoanActivity.this).load(hinhAnhKH).into(imageView);
                                        }
        ...
        tvKhachHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TaiKhoanActivity.this, DangNhapVaDangKyActivity.class);
        ...
        btnDiaChi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isLoggedIn) {
                    startActivity(new Intent(TaiKhoanActivity.this, DangNhapVaDangKyActivity.class));
                }
