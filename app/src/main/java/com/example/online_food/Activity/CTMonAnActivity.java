...
//import com.example.online_food.Adapter.DanhGiaAdapter;
//import com.example.online_food.Adapter.MADanhGiaAdapter;
...
import com.example.online_food.Util.CircleAnimationUtils;
...
//                        new AlertDialog.Builder(CTMonAnActivity.this)
//                                .setTitle("Thông báo")
//                                .setMessage("Số lượng món cần thêm nhiều hơn số lượng tồn của quán!")
//                                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
//                                    @Override
//                                    public void onClick(DialogInterface dialog, int which) {
//
...
//
//                    // Truy vấn để kiểm tra tồn tại của sản phẩm trong giỏ hàng
...
//                                                        }
//                                                    });
//                                            /*referenceCTGH.add(item)
//                                                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
//                                                        @Override
//                                                        public void onSuccess(DocumentReference documentReference) {
//                                                            Toast.makeText(CTMonAnActivity.this, "Add success!", Toast.LENGTH_SHORT).show();
//                                                        }
//                                                    })
//                                                    .addOnFailureListener(new OnFailureListener() {
//                                                        @Override
//                                                        public void onFailure(@NonNull Exception e) {
//                                                            Toast.makeText(CTMonAnActivity.this, "Add fail!", Toast.LENGTH_SHORT).show();
//                                                        }
//                                                    });*/
//                                        }
//                                    } else {
...
//        });
    ...
    private void makeFlyAnimation(ImageView targetView) {
        ...
        new CircleAnimationUtils().attachActivity(this).setTargetView(targetView).setMoveDuration(500).setDestView(ivCart).setAnimationListener(new Animator.AnimatorListener() {
            @Override
...
//        dialog.setContentView(R.layout.layout_gio_hang);
//
//        TextView tvXoaTatCa = dialog.findViewById(R.id.tvXoaTC);
//        ImageView ivDong = dialog.findViewById(R.id.ivDong);
//        RecyclerView viewGioHang = dialog.findViewById(R.id.viewGioHang);
//        Button btnGiaoHang = dialog.findViewById(R.id.btnMuaHang);
//        TextView tvTinhTien = dialog.findViewById(R.id.tvTinhTien);
//
//        dialog.show();
