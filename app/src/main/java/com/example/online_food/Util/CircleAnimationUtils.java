...
public class CircleAnimationUtils {
    ...
    public CircleAnimationUtils() {
    }

    public CircleAnimationUtils attachActivity(Activity activity) {
        mContextReference = new WeakReference<Activity>(activity);
        return this;
    }

    public CircleAnimationUtils setTargetView(View view) {
        mTarget = view;
        setOriginRect(mTarget.getWidth(), mTarget.getHeight());
        return this;
    }

    private CircleAnimationUtils setOriginRect(float x, float y) {
        originX = x;
        originY = y;
        return this;
    }

    private CircleAnimationUtils setDestRect(float x, float y) {
        destX = x;
        destY = y;
        return this;
    }

    public CircleAnimationUtils setDestView(View view) {
        mDest = view;
        setDestRect(mDest.getWidth(), mDest.getWidth());
        return this;
    }

    public CircleAnimationUtils setBorderWidth(int width) {
        mBorderWidth = width;
        return this;
    }

    public CircleAnimationUtils setBorderColor(int color) {
        mBorderColor = color;
        return this;
    }

    public CircleAnimationUtils setCircleDuration(int duration) {
        mCircleDuration = duration;
        return this;
    }

    public CircleAnimationUtils setMoveDuration(int duration) {
...
//        mTarget.setVisibility(View.VISIBLE);
    ...
    public CircleAnimationUtils setAnimationListener(Animator.AnimatorListener listener) {
